  ...
  .container.tarjeta.tarjeta--blanca.p-4.p-md-5
    ...
    .row.mb-5.justify-content-center.align-items-center.align-items-lg-stretch
      ...
      .col-12.col-md-8.col-lg-9(data-aos="fade-left")
        .titulo-segundo
          h2 Estrategias para la formación
        p.mb-4 Identificar cómo se aplican las estrategias en contextos educativos, promoviendo una reflexión crítica sobre su uso y efectividad en el proceso de enseñanza-aprendizaje.
